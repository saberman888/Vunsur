...
SRC := source/Script.cpp source/Info.cpp source/selfaccount.cpp source/condition.cpp source/user.cpp source/gold.cpp source/Error.cpp
OBJ := Info.o Script.o selfaccount.o condition.o user.o gold.o Error.o 
...
all:
	...
	$(GCC) $(FLAGS) $(INC) -DDEBUG=1 -c $(SRC) $(LINK_LIB)
